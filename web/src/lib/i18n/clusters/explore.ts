...
export const en: Dict = {
  ...
  "explore.results.filteredFoldHint": "Dropped by the collection gates (city / title keyword) — they never reached the results. Read-only: to keep one, add its word to portals.yml's title_filter and re-scan, so the seen ledger keeps matching the inbox.",
...
export const zh: Dict = {
  ...
  "explore.results.filteredFoldHint": "被采集门（城市／标题关键词）毙掉，从未进结果区。只读：要留下某条，请把它的词加进 portals.yml 的 title_filter 再重扫——这样「见过」台账才始终与收件箱事实一致。",
