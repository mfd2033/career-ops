...
export const en: Dict = {
  ...
  "explore.disc.castingExtension": "Scanning the boards through the 职位评估 extension…",
  "explore.disc.collected": "Collected {n} roles so far…",
  ...
  "explore.card.salaryUnknown": "salary unknown",
  "explore.card.salaryUnknownTitle": "No monthly salary could be parsed from the posting card — kept and tagged, never dropped.",
  ...
  "explore.filter.zhCityHint": "known cities only; unset = your location preference",
  "explore.filter.zhCityPreference": "Use my location preference ({city})",
  "explore.filter.zhCityUnset": "Unset — no preference city, no city filter",
  "explore.filter.zhCityAny": "Whole country (no city filter)",
  "explore.filter.browserSources": "Platforms",
  "explore.filter.browserSourcesHint": "pick at least one",
  "explore.filter.zhSalaryMin": "Salary floor (monthly K, optional)",
  "explore.filter.zhSalaryMinPlaceholder": "e.g. 20 = ≥20K/mo",
  "explore.filter.zhSalaryMinHint": "range-overlap match; unknown-salary jobs kept & tagged",
  ...
  "explore.results.selectAll": "Select all addable ({n})",
  "explore.results.clearSelection": "Clear selection",
  "explore.results.addSelected": "Add to pipeline ({n})",
  "explore.results.restoreSeen": "Restore recent un-added finds",
  "explore.results.restoreSeenTitle": "Rebuild the results area from seen-ledger rows that were collected recently but never added to the pipeline (ADR-0021)",
  "explore.results.restoring": "Restoring…",
  "explore.results.selectAria": "Select {title}",
  ...
  "explore.results.filteredFold": "Filtered out ({n})",
  "explore.results.filteredFoldHint": "Dropped by the title gate — they never reached the results, and every row says what killed it: the word it hit, or that no allow word matched. Read-only: to keep one, change the list above and re-scan, so the seen ledger keeps matching the inbox.",
  "explore.results.gateSummary": "Title gate: {p} allow · {n} deny · {f} filtered out this run",
  "explore.results.gateUnset": "Title gate unconfigured (no allow/deny words) — no posting is filtered by title",
  "explore.results.gatePositiveGroup": "Allow — keep a title only if it matches one",
  "explore.results.gateNegativeGroup": "Deny — drop a title if it matches one",
  "explore.results.gateNone": "(none)",
  "explore.results.gateQueryNote": "Your search words decide what the sites return; this list decides what stays. So a result whose title doesn't contain your search words is expected — it matched this list, not the search box.",
  "explore.results.gateUnsaved": "unsaved",
  "explore.results.gateAddPlaceholder": "add a word",
  "explore.results.gateAdd": "Add this word",
  "explore.results.gateRemove": "Remove {w}",
  "explore.results.gateTrial": "Re-judged with this list: {rescue} would come back · {drop} would be dropped",
  "explore.results.gateTrialRescue": "would come back",
  "explore.results.gateTrialDrop": "would be dropped",
  "explore.results.gateTrialNote": "Same rule the gate uses, applied to the results on screen. Saving does not re-scan — the list takes effect on your next one.",
  "explore.results.gateSave": "Save to portals.yml",
  "explore.results.gateSaving": "Saving…",
  "explore.results.gateDiscard": "Discard changes",
  "explore.results.gateSaved": "Saved — takes effect on the next scan",
  "explore.results.gateSaveFailed": "Couldn't save: {msg}",
  "explore.results.filteredReasonNegative": "killed by {words}",
  "explore.results.filteredReasonNoPositive": "matched no allow word",
  "explore.results.filteredMore": "+{n} more",
...
export const zh: Dict = {
  ...
  "explore.disc.castingExtension": "正在通过职位评估扩展采集三站…",
  "explore.disc.collected": "已采集 {n} 条…",
  ...
  "explore.card.salaryUnknown": "薪资未知",
  "explore.card.salaryUnknownTitle": "无法从职位卡片解析出月薪——已保留并打标，不会误删。",
  ...
  "explore.filter.zhCityPlaceholder": "郑州，北京…",
  "explore.filter.zhCityHint": "仅支持已知城市；未设置 = 用你的偏好城市",
  "explore.filter.zhCityPreference": "跟随我的偏好城市（{city}）",
  "explore.filter.zhCityUnset": "未设置（无偏好城市，按城市不过滤）",
  "explore.filter.zhCityAny": "全国（不限城市）",
  "explore.filter.browserSources": "平台",
  "explore.filter.browserSourcesHint": "至少选择一个",
  "explore.filter.zhSalaryMin": "薪资下限（月薪 K，可选）",
  "explore.filter.zhSalaryMinPlaceholder": "如 20 = ≥20K/月",
  "explore.filter.zhSalaryMinHint": "区间重叠判定；无薪资岗位保留并标记",
  ...
  "explore.results.selectAll": "全选可加入 ({n})",
  "explore.results.clearSelection": "清除选择",
  "explore.results.addSelected": "加入管道 ({n})",
  "explore.results.restoreSeen": "恢复近期未入管的采集",
  "explore.results.restoreSeenTitle": "从「见过」台账里重建近期采集、但从未入管的结果（ADR-0021）",
  "explore.results.restoring": "恢复中…",
  "explore.results.selectAria": "选择 {title}",
  ...
  "explore.results.filteredFold": "已过滤（{n}）",
  "explore.results.filteredFoldHint": "被标题门毙掉，从未进结果区；每行都写着它是被哪个词毙的（或没命中任何白名单词）。只读：要留下某条，请改上面的词表再重扫——这样「见过」台账才始终与收件箱事实一致。",
  "explore.results.gateSummary": "标题门：白名单 {p} 条 · 黑名单 {n} 条 · 本次被毙 {f} 条",
  "explore.results.gateUnset": "标题门未设置（白名单与黑名单都是空的）——不按标题筛任何岗位",
  "explore.results.gatePositiveGroup": "白名单 —— 命中任一才留下",
  "explore.results.gateNegativeGroup": "黑名单 —— 命中任一即淘汰",
  "explore.results.gateNone": "（无）",
  "explore.results.gateQueryNote": "检索词只决定站点返回什么，这张词表决定留下什么——所以结果里出现不含检索词的岗位是预期的：它命中的是词表，不是搜索框。",
  "explore.results.gateUnsaved": "未保存",
  "explore.results.gateAddPlaceholder": "加一个词",
  "explore.results.gateAdd": "加这个词",
  "explore.results.gateRemove": "删除 {w}",
  "explore.results.gateTrial": "按这张表重判：会放行 {rescue} 条 · 会多毙 {drop} 条",
  "explore.results.gateTrialRescue": "会放行",
  "explore.results.gateTrialDrop": "会多毙",
  "explore.results.gateTrialNote": "用的是与门控同一套判定，比的是屏上这批结果。保存不会重扫——词表在下一次扫描生效。",
  "explore.results.gateSave": "保存到 portals.yml",
  "explore.results.gateSaving": "保存中…",
  "explore.results.gateDiscard": "放弃改动",
  "explore.results.gateSaved": "已保存 —— 下次扫描生效",
  "explore.results.gateSaveFailed": "保存失败：{msg}",
  "explore.results.filteredReasonNegative": "被「{words}」毙掉",
  "explore.results.filteredReasonNoPositive": "未命中任何白名单词",
  "explore.results.filteredMore": "另有 {n} 条",
