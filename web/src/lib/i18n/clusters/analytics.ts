...
export const en: Dict = {
  ...
  "analytics.company.unknownEmployer": "Anonymous employer (via agency)",
  "analytics.drill.viewInPipeline": "View these {n} in the pipeline",
...
export const zh: Dict = {
  ...
  "analytics.company.unknownEmployer": "匿名雇主（代招）",
  "analytics.drill.viewInPipeline": "在管道中查看这 {n} 条",
