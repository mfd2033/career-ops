...
export const en: Dict = {
  ...
  // 体检分数（ADR-0064）—— data/company-checkups.tsv 最近一次 star
  "pipeline.col.checkup": "checkup",
  ...
  // ── Company checkup button (ADR-0026/0027, repeat/replace ADR-0033) ──
  "pipeline.checkup": "Check this company",
  "pipeline.checkupRecheck": "Re-check",
  "pipeline.checkupRunning": "Checking…",
  "pipeline.checkupQueued": "Queued…",
  "pipeline.checkupJobTitle": "Company checkup: {company}",
  "pipeline.checkupDispatchTitle": "Dispatches a checkup worker now; if this row is already being checked you decide between stopping it and re-checking (concurrency pool, progress on /jobs)",
  ...
  "pipeline.checkupFailed": "Failed to dispatch the checkup worker",
  "pipeline.checkupStopFailed": "Nothing stopped — this checkup had already ended.",
  "pipeline.checkupStopped": "Stopped this checkup. Anything already written stays.",
  "pipeline.checkupPanelRunning": "This row is being checked right now ({min} min in)",
  "pipeline.checkupPanelQueued": "Dispatched — waiting for a concurrency slot",
  "pipeline.checkupPanelNoRollback": "Anything already written is not rolled back — the checkup ledger only appends.",
  "pipeline.checkupPanelOpenJob": "Open the running worker",
  "pipeline.checkupPanelStop": "Stop",
  "pipeline.checkupPanelReplace": "Stop and re-check",
  "pipeline.checkupPanelDismiss": "Close",
  "pipeline.checkupPanelUnconfirmed": "The previous process did not confirm it stopped — it may still write.",
...
export const zh: Dict = {
  ...
  // ── 公司体检按钮（ADR-0026/0027，重复与替换见 ADR-0033） ──
  "pipeline.checkup": "体检这家",
  "pipeline.checkupRecheck": "复检",
  "pipeline.checkupRunning": "体检中…",
  "pipeline.checkupQueued": "排队中…",
  "pipeline.checkupJobTitle": "公司体检：{company}",
  "pipeline.checkupDispatchTitle": "立即派发体检 worker；本行已在体检时先由你决定停止还是重新体检（并发池执行，进度见 /jobs）",
  "pipeline.checkupNoVia": "未知雇主行没有可体检的招聘主体（Via）",
  "pipeline.checkupNoRow": "此报告没有对应的 tracker 行",
  "pipeline.checkupFailed": "体检 worker 派发失败",
  "pipeline.checkupStopFailed": "没能停下——这次体检已经结束了。",
  "pipeline.checkupStopped": "已停止本次体检（已产生的产出照旧保留）。",
  "pipeline.checkupPanelRunning": "这一行正在体检中（已运行 {min} 分钟）",
  "pipeline.checkupPanelQueued": "已派发，正在排队等并发槽",
  "pipeline.checkupPanelNoRollback": "已产生的产出不回滚——体检台账只追加。",
  "pipeline.checkupPanelOpenJob": "查看正在跑的工作器",
  "pipeline.checkupPanelStop": "停止",
  "pipeline.checkupPanelReplace": "停止并重新体检",
  "pipeline.checkupPanelDismiss": "关闭",
  "pipeline.checkupPanelUnconfirmed": "旧进程未确认停止，仍可能产生写入。",
