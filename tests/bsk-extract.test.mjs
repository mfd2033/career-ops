...
// Zhipin search pages return ~80 anchors: nav chrome (APP, 消息, 张三),
...
// against the base URL before the pattern match.
{
  ...
  const anchors = [
    { href: '/web/geek/recommend', label: '张三' },
...
// Must NOT confuse experience years ("5-10年") or "13薪" standalone with salary.
{
  const cases = [
    ...
    ['项目经理 30K以上 经验不限', '30K'],
    // BOSS PUA 数字经实证映射（E031+n = 数字 n；E03A=9 于 2026-09-14 列表页取证 +
    // 详情页明文反查确认）解码后可提取
    ['\uE032\uE036-\uE034\uE031K·\uE032\uE034薪 3-5年 大专', '15-30K·13薪'],
    ['项目经理 \uE033\uE031-\uE034\uE031K 五年', '20-30K'],
    ['\uE039-\uE03AK 经验不限 郑州', '8-9K'],
    ['项目经理 \uE03A-\uE032\uE031K 经验不限', '9-10K'],
    // 至今零观测的 PUA 码点（E030）混入 → 部分解码失真，整体归「薪资未知」
    ['项目经理 1\uE030-15K 经验不限', ''],
    ['项目经理 5-10年 大专', ''],
    ['项目经理', ''],
    ['', ''],
